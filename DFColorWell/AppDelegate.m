...
- (void) _generateColors {
    ...
    _colors[@"(0,4)"] = [NSColor colorWithCalibratedRed:0.0 green:0.0 blue:0.0 alpha:1.0];
    ...
    _colors[@"(1,4)"] = [NSColor colorWithCalibratedRed:0.6 green:0.6 blue:0.6 alpha:1.0];
    ...
    _colors[@"(2,4)"] = [NSColor colorWithCalibratedRed:0.4 green:0.4 blue:0.4 alpha:1.0];
    ...
    _colors[@"(3,4)"] = [NSColor colorWithCalibratedRed:0.2 green:0.2 blue:0.2 alpha:1.0];
    ...
    _colors[@"(4,4)"] = [NSColor colorWithCalibratedRed:0.0 green:0.0 blue:0.0 alpha:1.0];
